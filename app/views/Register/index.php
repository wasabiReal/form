        ...
        <form action="assets/scripts/form.php" method="POST" id="register-form">
            ...
            <div class="tab" id="tab-2" style="display: block;">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="position" id="position" placeholder="CEO">
                </div>
                <div class="mb-3">
                    <p class="form-label">About me</p>
                    <textarea name="about" id="about" cols="45" rows="5" placeholder="I am looking for new clients.."></textarea>
                </div>
                <div class="mb-3">
